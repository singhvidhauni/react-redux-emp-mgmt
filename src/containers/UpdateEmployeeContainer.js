...
const UpdateEmployeeContainer = ({
  ...
  const [showRecordToUpdate, setShowRecordToUpdate] = useState(true);
  ...
  const handleSubmitUpdatedRec = (e) => {
    e.preventDefault();
    console.log("handleSubmitUpdatedRec: ", eName, " dptName ", dptName);
...
export default connect(mapStateToProps, { fetchEmpRecord, updateEmployee })(
